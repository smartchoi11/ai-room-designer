...
export default function MobileAppView() {
  ...
  const runGeneration = async () => {
    ...
    if (selectedTool.id === 'layout') {
      ...
      customPrompt = `STRICTLY PRESERVE 100% of all room architecture, walls, windows, doors, ceiling, flooring, built-in kitchen cabinets, stoves, and camera viewpoint. ABSOLUTELY DO NOT add new windows, DO NOT replace solid walls or kitchen cabinets with windows or glass doors. ABSOLUTELY DO NOT change the shape, color, wood tone, or fabric material of any checked furniture. Reorganize, rearrange, and reposition ONLY these specific selected items: [${itemsStr}] into an optimized, functional layout while maintaining 100% identical shapes, colors, wall cabinets, and structural boundaries.`;
