...
export default function MobileAppView() {
  ...
  const runGeneration = async () => {
    ...
    if (selectedTool.id === 'layout') {
      ...
      customPrompt = `STRICTLY PRESERVE 100% of all room architecture, walls, windows, doors, ceiling, flooring, camera viewpoint, and outdoor window view. ABSOLUTELY DO NOT change the shape, color, wood tone, or fabric material of any furniture or prop. Reorganize, rearrange, and reposition ONLY these specific selected items: [${itemsStr}] into an optimized, functional layout while maintaining 100% identical shapes, colors, and structural boundaries.`;
